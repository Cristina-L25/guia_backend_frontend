...
// Se crea un "pool" de conexiones a la base de datos. createPool() crea un grupo de conexiones reutilizables, lo cual es más eficiente que abrir y cerrar una conexión para cada consulta
