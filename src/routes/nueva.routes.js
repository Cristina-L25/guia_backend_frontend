...
// Crear un nuevo router de Express para mnejar rutas de manera modular
const router = express.Router();

// Importar el controlador genérico para operaciones CRUD
const CrudController = require('../controllers/crud.controller');

// Instanciar una nueva instancia del controlador para usar métodos
const crud = new CrudController();

// Definir el nombre de la tabla en la base de datos sobre la que se operará
